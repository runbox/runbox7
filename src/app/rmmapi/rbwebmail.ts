...
import { catchError, concatMap, share, filter, map, mergeMap, tap } from 'rxjs/operators';
...
export class RunboxWebmailAPI {
    ...
    public async downloadMessages(messageIds: number[]): Promise<MessageContents[]> {
        ...
        return messagePromises.length > 0
            ? messagePromises[0]
