    ...
    template: `
        ...
        <mat-dialog-content  *ngIf="!moving">
            <mat-nav-list dense id="moveMessagesToFolderList">
                ...
                >
                <mat-icon *ngIf="fce.folderType==='inbox'" matListItemIcon svgIcon="inbox-arrow-down"></mat-icon>
                <mat-icon *ngIf="fce.folderType==='sent'" matListItemIcon svgIcon="send"></mat-icon>
                <mat-icon *ngIf="fce.folderType==='spam'" matListItemIcon svgIcon="cancel"></mat-icon>
                <mat-icon *ngIf="fce.folderType==='templates'" matListItemIcon svgIcon="file-document"></mat-icon>
                <mat-icon *ngIf="fce.folderType==='trash'" matListItemIcon svgIcon="delete"></mat-icon>
